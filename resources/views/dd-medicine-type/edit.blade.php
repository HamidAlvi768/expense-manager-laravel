    ...
    <div class="row col-12 m-0 p-0">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <div class="col-md-8">
<<<<<<< HEAD
                    <input type="submit" value="@lang('Update')" class="btn btn-outline btn-info btn-md"/>
                    <a href="{{ route('dd-medicine-types.index') }}" class="btn btn-outline btn-warning btn-md">@lang('Cancel')</a>
=======
