...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="scheduleForm" class="bg-custom form-material form-horizontal" action="{{ route('patient-appointments.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
<<<<<<< HEAD
                            <input type="submit" value="{{ __('entire.submit') }}" class="btn btn-outline btn-info btn-md"/>
                            <a href="{{ route('patient-appointments.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('currency.cancel') }}</a>
=======
