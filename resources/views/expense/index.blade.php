            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Expenses List')</li>
                    </ol>
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4 align-content-center">
                                        ...
                                        @if (request()->isFilterActive)
                                            <a href="{{ route('expenses.index') }}" class="btn btn-secondary mt-4">@lang('Clear')</a>
                                        @endif
                                    </div>
                                </div>
                            </form>
                        ...
                        <tbody>
                            ...
                            <tr style="background: linear-gradient(to right, rgba(255,255,255,0) 0%, {{ $categoryColors[$item->expense_category_id] ?? '#FFFFFF' }} 50%, rgba(255,255,255,0) 100%);">
                                <td>{{ $item->account->account_title ?? '-' }}</td>
                                    ...
                                    <td>
                                        <a href="{{ route('expenses.show', $item->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('View')">
                                            <i class="fa fa-eye ambitious-padding-btn"></i>
                                        </a>
                                        <a href="{{ route('expenses.edit', $item->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Edit')">
                                            <i class="fa fa-edit ambitious-padding-btn"></i>
                                        </a>
                                        <a href="#" data-href="{{ route('expenses.destroy', $item->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="modal" data-target="#myModal" title="@lang('Delete')">
                                            <i class="fa fa-trash ambitious-padding-btn"></i>
                                        </a>
                                        <a href="{{ route('expenses.markImportant', $item->id) }}" class="btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip" title="@lang('Mark as Important')">
                                            <i class="fa fa-star ambitious-padding-btn"></i>
                                        </a>
                                    </td>
                                </tr>
                            @endforeach
