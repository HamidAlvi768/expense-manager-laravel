                            ...
                            <div class="account-date-container">
                                ...
                                <div class="form-group" style="margin-right: -6.5%;">
                                    ...
                                    <input type="date" id="expense_date" name="expense_date"
                                        value="{{ old('expense_date', now()->format('Y-m-d')) }}" class="form-control"
                                        required data-parsley-required-message="Please select a date" style="width: 87%;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td data-label="@lang('Amount')">
                                                <input type="number" name="expense_items[0][amount]"
                                                    class="form-control amount" placeholder="Amount" step="1" min="1"
                                                    required data-parsley-required-message="Please enter an amount"
                                                    data-parsley-min="1"
