                  ...
                  <div class="row col-12 p-0 m-0">
                      ...
                      <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                          <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-3">
                                <div class="form-group">
                                    <label for="date_of_birth">@lang('DOB (Year-Month-Day)')</label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                        ...
                                        <input type="text" name="date_of_birth" id="date_of_birth"
                                            ...
                                            placeholder="@lang('1990-12-31')" value="{{ old('date_of_birth') }}">
                                        @error('date_of_birth')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
...
<<<<<<< HEAD
                                        class="btn btn-outline btn-info btn-md mb-2" />
                                    <a href="{{ route('patient-details.index') }}"
                                        class="btn btn-outline btn-warning btn-md mb-2">{{ __('Cancel') }}</a>
=======
