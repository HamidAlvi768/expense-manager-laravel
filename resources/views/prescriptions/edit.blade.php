            ...
            <div class="row">
                <div class="col-sm-8">
                    <div class="col-sm-6 d-flex">
                        ...
                        <h3>
                            <a href="{{ route('prescriptions.show', $prescription) }}" class="btn btn-outline btn-info"><i
                                    ...
                                    <table id="t1" class="table">
                                            ...
                                            @else
                                                @foreach ($prescription->patientmedicineitem as $item)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select name="days[]" class="form-control  @error('days') is-invalid @enderror" id="days">
                                                                <option value="">Days</option>
                                                                @for ($i=1; $i<=31; $i++)
                                                                    <option value="{{ $i }}" {{ $item->days == $i ? 'selected' : '' }}>
                                                                        {{ $i }}
                                                                    </option>
                                                                @endfor
                                                            </select>
                                                        ...
                                                        <td>
                                                            <select name="weeks[]" class="form-control  @error('weeks') is-invalid @enderror" id="weeks">
                                                                <option value="">Week</option>
                                                                @for ($i=1; $i<=52; $i++)
                                                                    <option value="{{ $i }}" {{ $item->weeks == $i ? 'selected' : '' }}>
                                                                        {{ $i }}
                                                                    </option>
                                                                @endfor
                                                            </select>
                                                        ...
                                                        <td>
                                                            <select name="months[]" class="form-control  @error('months') is-invalid @enderror" id="months">
                                                                <option value="">Month</option>
                                                                @for ($i=1; $i<=12; $i++)
                                                                    <option value="{{ $i }}" {{ $item->months == $i ? 'selected' : '' }}>
                                                                        {{ $i }}
                                                                    </option>
                                                                @endfor
                                                            </select>
                                        ...
                                        <tbody id="medicine">
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" name="medicine_description[]" class="form-control" id="medicine_description">
                                                </td>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <a href="{{ route('prescriptions.index') }}"
                                            class="btn btn-outline btn-warning btn-md">@lang('Cancel')</a>
                                    </div>
                                </div>
                            </div>
                        </div>
