                ...
                <form id="patientForm" class="form-material form-horizontal bg-custom" action="{{ route('patient-case-studies.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                            ...
                            <div class="form-group">
                                ...
                                <select name="user_id" id="user_id"
                                    ...
                                    @foreach($patientInfo as $key => $value)
                                        <option value="{{ $key }}" @if($key == old('user_id', $selectedPatient ?? '')) selected @endif>
                                            {{ $value }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row col-12 p-0 m-0">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="file"  name="file" type="file" data-allowed-file-extensions="png jpg jpeg pdf" data-max-file-size="5120K" />
...
<<<<<<< HEAD
                                    ...
                                    <a href="{{ route('patient-case-studies.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
