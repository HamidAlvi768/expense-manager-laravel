    ...
    <section>
        ...
        <div class="email-body">
            <center><img
                    ...
                    alt="Clinic Logo" style="height: 100px;"></center>
            <h2 style="text-align: center; color: #004a99;">Dear {{ $name }},</h2>
            <p>Thank you for visiting our dental clinic. We are delighted to have you as our patient and are committed
                to providing you with the best dental care possible.</p>
            <p>Our clinic offers a wide range of services, including routine check-ups, cleanings, fillings, and more.
                Our team of experienced professionals is here to ensure that your visit is as comfortable and pleasant
                as possible.</p>
            <p>If you have any questions or need to schedule your next appointment, please don't hesitate to contact us
                at {{ $clinicPhone }} or email us at {{ $clinicEmail }}.</p>
