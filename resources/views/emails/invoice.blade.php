@component('mail::message')
    ...
    <div class="email-body">
        @if ($recipientType === 'admin')
            <p style="font-family: Arial, sans-serif;">A new invoice has been created for Patient Named {{ $userName }}
                with Doctor {{ $doctorName }}. Invoice Number: {{ $invoiceNumber }}.</p>
        @else
            <p style="font-family: Arial, sans-serif;">Hi {{ $userName }},</p>
            <p style="font-family: Arial, sans-serif;">Your invoice has been generated with Invoice Number:
                {{ $invoiceNumber }} against the Treatment Plan Number: {{ $treatmentPlanNumber }} formulated by Dr.
                {{ $doctorName }}. Your Grand Total is: {{ $grandTotal }}, dated as: {{ $invoiceDate }}.</p>
        @endif
