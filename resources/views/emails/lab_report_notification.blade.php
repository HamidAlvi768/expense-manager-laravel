@component('mail::message')
    ...
    <div class="email-body">
        ...
        @elseif ($recipientType === 'admin')
            ...
            <p>We would like to inform you that a new lab report has been created and is now available for review. Please
                take a moment to check the details and ensure that everything is in order.</p>
        @endif
