...
<<<<<<< HEAD
                        <a href="{{ route('patient-details.index') }}" class="btn btn-outline btn-warning btn-md">
                            @lang('Patient List')
                        </a>
                        <a href="{{ route('consultancey-fees.index') }}" class="btn btn-outline btn-info btn-md ml-2">
=======
