            ...
            <div class="row mb-2">
                    ...
                    <div class="d-flex align-items-center">
                        <h3 class="mb-0">
                            <a href="{{ route('dd-account-type.create') }}" class="btn btn-outline btn-info">
                                + @lang('Add Account Type')
                            </a>
                        </h3>
                        <div class="ml-auto d-flex gap-2">
                            <a class="btn btn-sm btn-default" target="_blank" href="{{ route('dd-account-type.index') }}?export=1">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Account Type')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Account Types List')</h3>
                </div>
                <div class="card-body">
                    ...
                    <table class="table table-striped" id="laravel_datatable">
                        ...
                        <tbody>
                            @foreach ($accountTypes as $DdAccountTypes)
                                <tr>
                                    
                                    <td><span style="text-wrap:nowrap;">{{ $DdAccountTypes->title }}</span></td>

                                    <td>
                                        @if ($DdAccountTypes->status == 1)
                                    ...
                                    <td class="responsive-width">
                                        <a href="{{ route('dd-account-type.show', $DdAccountTypes) }}"
                                        ...
                                        @can('doctor-detail-update')
                                            <a href="{{ route('dd-account-type.edit', $DdAccountTypes) }}"
                                                class="responsive-width-item btn btn-info btn-outline btn-circle btn-lg" data-toggle="tooltip"
                                                title="@lang('Edit')"><i class="fa fa-edit ambitious-padding-btn"></i></a>
                                        @endcan

                                        <a href="#" data-href="{{ route('dd-account-type.destroy', $DdAccountTypes) }}"
