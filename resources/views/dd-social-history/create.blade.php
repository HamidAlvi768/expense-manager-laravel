...
<section class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3><a href="{{ route('dd-social-history.index') }}" class="btn btn-outline btn-info">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dd-social-history.index') }}">@lang('All Options')</a></li>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal bg-custom" action="{{ route('dd-social-history.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    data-parsley-required-message="Please enter social history title." data-parsley-trigger="change focusout">
                                    @error('title')
...
<<<<<<< HEAD
                                    ...
                                    <a href="{{ route('dd-social-history.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
                                    <input type="submit" value="{{ __('Submit') }}" class="btn btn-outline btn-info btn-lg"/>
                                    <a href="{{ route('dd-social-history.index') }}" class="btn btn-outline btn-warning btn-lg">{{ __('Cancel') }}</a>
