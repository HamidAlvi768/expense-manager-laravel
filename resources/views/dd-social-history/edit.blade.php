            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Edit Social History')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">Edit Social History ({{ $DdSocialHistory->title }})</h3>
                </div>
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal bg-custom"
    action="{{ route('dd-social-history.update', $DdSocialHistory) }}" method="POST" enctype="multipart/form-data"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="name" name="title"
                        value="{{ old('name', $DdSocialHistory->title) }}"
                        class="form-control @error('title') is-invalid @enderror"
                        placeholder="@lang('Title')" required
                        data-parsley-required-message="Please enter social history title.">
                    @error('title')
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="email" name="description"
                        value="{{ old('email', $DdSocialHistory->description) }}"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-control ambitious-form-loading @error('status') is-invalid @enderror"
                        ...
                        <option value="1"
                            {{ old('status', $DdSocialHistory->status) === '1' ? 'selected' : '' }}>
                            @lang('Active')
                        </option>
                        <option value="0"
                            {{ old('status', $DdSocialHistory->status) === '0' ? 'selected' : '' }}>
                            @lang('Inactive')
                        </option>
                    </select>
                    @error('status')
