                ...
                <div class="col-md-12">
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="card-body">
                                <form class="form-material form-horizontal bg-custom" action="{{ route('general') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <div class="row col-12 m-0 p-0">
                                            <div class="col-md-6">
                                                <label>{{ __('Logo') }}</label>
                                                <input id="photo"  name="company_logo" type="file" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="1024K"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            @can('company-update')
<<<<<<< HEAD
                                                <input type="submit" value="{{ __('Save') }}" class="btn btn-outline btn-info btn-md"/>
                                            @endcan
...
>>>>>>> 59200bb (Initial commit with expense manager code)
                        ...
                        <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                            <div class="card-body">
                                <form class="form-material form-horizontal bg-custom" action="{{ route('general.localisation') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <div class="row col-12 m-0 p-0">
                                            <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8">
                                            @can('company-update')
<<<<<<< HEAD
                                                <input type="submit" value="@lang('Save')" class="btn btn-outline btn-info btn-md"/>
                                            @endcan
                                            <a href="{{ route('dashboard') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
