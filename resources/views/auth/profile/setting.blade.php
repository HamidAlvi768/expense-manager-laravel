                    ...
                    <form class="form-material form-horizontal" action="{{ route('profile.updateSetting') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                ...
                                <input id="photo"  name="photo" value="{{ old('photo') }}" type="file" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="5120K"/><small id="name" class="form-text text-muted">{{ __('Leave Blank For Remain Unchanged') }}</small>
                            </div>
                            @if ($errors->has('photo'))
