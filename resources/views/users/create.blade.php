...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="userQuickForm" class="form-material form-horizontal bg-custom" action="{{ route('users.store') }}" method="post" enctype="multipart/form-data"  data-parsley-validate>
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" id="name" type="text" placeholder="@lang('Type Your Name Here')" required data-parsley-required-message="Please enter user name." data-parsley-pattern="^[a-zA-Z\s]+$" data-parsley-pattern-message="Name can only contain letters and spaces.">
                                    @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" id="email" type="email" placeholder="@lang('Type Your Email Here')" required data-parsley-required-message="Please enter user email." data-parsley-type="email" data-parsley-type-message="Please enter a valid email address.">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('password') is-invalid @enderror" name="password" id="password" type="password" placeholder="@lang('Type Your Password Here')" required data-parsley-required-message="Please enter a password." data-parsley-minlength="6" data-parsley-minlength-message="Password must be at least 6 characters long.">
                                    @error('password')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="password_confirmation" type="password" placeholder="@lang('Type Your Confirm Password Here')" required data-parsley-required-message="Please confirm user password." data-parsley-equalto="#password" data-parsley-equalto-message="Passwords do not match.">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('phone') is-invalid @enderror" name="phone" value="{{ old('phone') }}" id="phone" type="text" placeholder="@lang('Type Phone Number Here') data-parsley-required="true" data-parsley-required-message="Please select a user role."">
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
