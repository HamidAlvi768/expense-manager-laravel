...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-material form-horizontal bg-custom" action="{{ route('users.update', $user) }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('name') is-invalid @enderror" name="name" id="name" value="{{ old('name',$user->name) }}" type="text" placeholder="@lang('Type Your Name Here')" required data-parsley-required-message="Please enter user name" data-parsley-pattern="^[a-zA-Z\s]+$" data-parsley-pattern-message="Name should only contain letters and spaces">
                                    @error('name')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('email') is-invalid @enderror" name="email" id="email" value="{{ old('email', $user->email) }}" type="email" placeholder="{{ __('Type Your Email Here') }}" required data-parsley-required-message="Please enter user email" data-parsley-type="email" data-parsley-type-message="Please enter a valid email address">
                                    @error('email')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('password') is-invalid @enderror" name="password" id="password" type="password" placeholder="{{ __('Type Your Password Here') }}" data-parsley-minlength="6" data-parsley-minlength-message="Password must be at least 6 characters long">
                                    @error('password')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('password_confirmation') is-invalid @enderror" name="password_confirmation" id="password_confirmation" type="password" placeholder="{{ __('Type Your Confirm Password Here') }}" data-parsley-equalto="#password" data-parsley-equalto-message="Passwords must match">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <select class="form-control ambitious-form-loading @error('role_for') is-invalid @enderror" name="role_for" id="role_for" required data-parsley-required-message="Please select a user role">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input class="form-control ambitious-form-loading @error('phone') is-invalid @enderror" name="phone" id="phone" value="{{ old('phone',$user->phone) }}" type="text" placeholder="{{ __('Type Phone Number Here') }}" data-parsley-pattern="^[0-9]+$" data-parsley-pattern-message="Phone number should only contain digits">
                                    @error('phone')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div id="user_block col-12 m-0 p-0">
                    ...
                    <div class="form-group row">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <input id="photo" name="photo" value="{{ old('photo') }}" type="file" data-allowed-file-extensions="png jpg jpeg" data-max-file-size="2024K" />
                                <small id="name" class="form-text text-muted">{{ __('Leave Blank For Remain Unchanged') }}</small>
...
<<<<<<< HEAD
                            ...
                            <a href="{{ route('users.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
