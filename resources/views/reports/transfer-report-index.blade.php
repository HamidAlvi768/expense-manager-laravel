                    ...
                    <div class="d-flex align-items-center">
                        <div class="ml-auto d-flex gap-2">
                            ...
                            <a class="btn btn-sm btn-default" target="_blank"
                                href="{{ request()->fullUrlWithQuery(['export' => 1]) }}">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Transfer Report')</h3>
                </div>
                <div class="card-body">
                    <form id="filter"  class="collapse"action="{{ route('transfer-report.index') }}" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="date_from" id="date_from" class="form-control"
                                            placeholder="dd/mm/yyyy" value="{{ old('date_from', request()->date_from) }}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="date" name="date_to" id="date_to" class="form-control"
                                            placeholder="dd/mm/yyyy" value="{{ old('date_to', request()->date_to) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mobile-form-row">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="transfer_amount" id="transfer_amount" class="form-control"
                                        value="{{ old('transfer_amount', request()->transfer_amount) }}"
                                        placeholder="@lang('100.0')">
                                </div>
                                <div class="form-group">
                                    ...
                                    <tbody class="bg-custom">
                                        @forelse ($transfers as $index => $transfer)
                                            <tr>
                                                ...
                                                <td>{{ isset($transfer->transfer_amount) ? formatAmount($transfer->transfer_amount) : '-' }}
                                                </td>
                                        ...
                                        @empty
                                            <tr class="text-center">
                                                <td colspan="6" class="text-secondary">
                                                    @lang('No records found for the selected filter')</td>
                                            </tr>
                                        @endforelse
                                    </tbody>
                                </table>
