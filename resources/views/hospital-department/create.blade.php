                ...
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal" action="{{ route('hospital-departments.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="specialization">@lang('Specialization') <b class="ambitious-crimson">*</b></label>
                                        <div class="form-group input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-signature"></i></span>
                                            </div>
                                            <input type="text" id="specialization" name="specialization" value="{{ old('specialization') }}" class="form-control @error('specialization') is-invalid @enderror" placeholder="@lang('Specialization')" required>
                            ...
                            <div class="col-md-12 description_padding_left">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <textarea id="Text" class="form-control" name="description" value="{{ old('description') }}"></textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
<<<<<<< HEAD
                                        <input type="submit" value="@lang('Submit')" class="btn btn-outline btn-info btn-md"/>
                                        <a href="{{ route('hospital-departments.index') }}" class="btn btn-outline btn-warning btn-md">@lang('Cancel')</a>
=======
