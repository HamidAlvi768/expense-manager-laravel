                    ...
                    <div class="row col-12 m-0 p-0">
                        <div class="col-md-6">
                            <div class="form-group">
                                <div class="col-md-8">
<<<<<<< HEAD
                                    <button type="submit" class="btn btn-outline btn-info btn-md">@lang('Submit')</button>
                                    <a href="{{ route('dd-diagnoses.index') }}" class="btn btn-outline btn-warning btn-md">@lang('Cancel')</a>
=======
