            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Edit Expense Category')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">Edit Expense Category ({{ $DdExpenseCategory->title }})</h3>
                </div>
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal bg-custom"
      action="{{ route('dd-expense-category.update', $DdExpenseCategory) }}"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" id="title" name="title"
                           value="{{ old('title', $DdExpenseCategory->title) }}"
            ...
            <div class="form-group">
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-control ambitious-form-loading @error('status') is-invalid @enderror"
                            ...
                            data-parsley-trigger="change">
                        <option value="1" {{ old('status', $DdExpenseCategory->status) === '1' ? 'selected' : '' }}>
                            @lang('Active')
                        </option>
                        <option value="0" {{ old('status', $DdExpenseCategory->status) === '0' ? 'selected' : '' }}>
                            @lang('Inactive')
                        </option>
                    </select>
                    @error('status')
