...
<<<<<<< HEAD
                        <button type="submit" class="btn btn-outline btn-info btn-md mb-2 ml-2">Submit</button>
                        <a href="{{ route('tasks.index') }}" class="btn btn-outline btn-warning btn-md mb-2">Cancel</a>
=======
