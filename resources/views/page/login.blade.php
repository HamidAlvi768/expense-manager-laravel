...
<html lang="en">
    <head>
        ...
        <style>
            ...
            /* Password field and eye icon styling */
                    ...
                    <form action="{{ route('login') }}" method="post" data-parsley-validate>
                        ...
                        <div class="row d-flex justify-content-between align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('forgot-password.form') }}" class="text-info font-weight-bold">
                        ...
                        <div class="social-auth-links text-center mt-2 mb-3">
                            <button type="submit" class="btn btn-block btn-info" id="login-button">
