...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-material form-horizontal bg-custom" action="{{ route('apsetting.update') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row col-12 m-0 p-0">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="col-md-12 col-form-label"><h4>{{ __('Contact') }} <b class="ambitious-crimson">*</b></h4></label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-phone"></i></span>
                                    </div>
                                    <input class="form-control ambitious-form-loading @error('contact') is-invalid @enderror" name="contact" id="contact" type="text" placeholder="{{ __('Type Your contact') }}" value="{{ old('contact',$data->contact) }}" required>
                                    @error('contact')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                    ...
                    <div class="form-group row mb-0">
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="logo"  name="logo" value="{{ old('logo') }}" type="file" data-allowed-file-extensions="png" data-max-file-size="2024K" />
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                ...
                                <input id="favicon"  name="favicon" value="{{ old('favicon') }}" type="file" data-allowed-file-extensions="png" data-max-file-size="500K" />
                                <p>{{ __('Max Size: 2MB, Allowed Format: png') }}</p>
                            </div>
                        </div>
                    </div>
...
<<<<<<< HEAD
                            ...
                            <a href="{{ route('dashboard') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
