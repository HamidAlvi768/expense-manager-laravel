...
<section class="content-header">
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-6">
                <h3><a href="{{ route('soft-tissues.index') }}" class="btn btn-outline btn-info"><i class="fas fa-eye"></i> @lang('View All')</a>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('soft-tissues.index') }}">@lang('All Options')</a></li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="card-title">@lang('Add New Soft Tissues')</h3>
            </div>
            <div class="card-body">
                <form id="departmentForm" class="form-material form-horizontal bg-custom" action="{{ route('soft-tissues.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" id="name" name="soft_tissues_name" value="{{ old('soft_tissues_name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="@lang('Name')" required data-parsley-required="true"
...
<<<<<<< HEAD
                                    ...
                                    <a href="{{ route('soft-tissues.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
