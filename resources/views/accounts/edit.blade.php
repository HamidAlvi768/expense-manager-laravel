            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="accountForm" class="form-material form-horizontal bg-custom"
                        ...
                        data-parsley-validate action="{{ route('accounts.update', $account) }}" method="POST"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="account_title" name="account_title"
                                            value="{{ old('account_title', $account->account_title) }}" 59200bb (Initial
                                            commit with expense manager code)
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select name="account_type_id" id="account_type_id" class="form-control select2"
                                            ...
                                            {{-- <select name="account_type_id" id="account_type_id"
                                                ...
                                                data-parsley-required-message="Please Select a Account Type"> --}}
                                ...
                                <div class="form-group">
                                    ...
                                    {{-- <textarea name="notes" id="notes"
                                        class="form-control @error('notes') is-invalid @enderror" rows="4"> --}}
                                                <textarea
                                                name="notes" id="notes" class="form-control @error('notes') is-invalid @enderror"
                                                rows="4"
