            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item">
                        <a href="{{ route('dd-task-action.index') }}">@lang('All Options')</a>
                    </li>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header bg-info">
                <h3 class="card-title">@lang('Add New Task Action')</h3>
            </div>
            <div class="card-body">
                {{-- <form id="taskActionForm" class="form-material form-horizontal bg-custom" action="{{ route('dd-task-action.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
...
<<<<<<< HEAD
                                    ...
                                    <a href="{{ route('dd-task-action.index') }}" class="btn btn-outline btn-warning btn-md">@lang('Cancel')</a>
=======
                                    <input type="submit" value="{{ __('Submit') }}" class="btn btn-outline btn-info btn-lg"/>
                                    <a href="{{ route('dd-task-action.index') }}" class="btn btn-outline btn-warning btn-lg">@lang('Cancel')</a>
>>>>>>> 59200bb (Initial commit with expense manager code)
                ...
                <form id="taskActionForm" class="form-material form-horizontal bg-custom" action="{{ route('dd-task-action.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                    <div class="row col-12 m-0 p-0">
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    data-parsley-required-message="Please enter action title." data-parsley-trigger="change focusout">
                                    @error('title')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
