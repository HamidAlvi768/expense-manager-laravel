    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{-- <form class="bg-custom" id="dentalhistoryForm" action="{{ route('patient-dental-histories.store') }}" method="POST">
                        @csrf
                                    ...
                                    <div class="form-group m-0">
                                        ...
                                        <div class="form-group input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" id="details_{{ $item->id }}"
                                                name="dental_histories[{{ $item->id }}][comments]" disabled>
                                        </div>
                    ...
                    <form class="bg-custom" id="dentalhistoryForm" action="{{ route('patient-dental-histories.store') }}" method="POST" data-parsley-validate>
                        @csrf
                        <div class="row col-12 m-0 p-0">
                            <div class="col-md-6">
                                <div class="form-group">
                            ...
                            @foreach ($ddDentalHistory as $item)
                                <div class="col-xl-4 p-3">
                                    <div class="form-group m-0">
                                        <input type="checkbox" id="title_{{ $item->id }}"
                                            name="dental_histories[{{ $item->id }}][checked]"
                                            class="dental-history-checkbox" data-parsley-multiple="dental_histories" data-parsley-trigger="change">
                                        <label for="title_{{ $item->id }}">{{ $item->title }}</label>
                                        <div class="form-group input-group mb-3">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text"><i class="fas fa-plus-square"></i></span>
                                            </div>
                                            <input type="text" class="form-control dental-history-input" id="details_{{ $item->id }}"
    ...
    <script>
        $(document).ready(function() {
            $('input[type="checkbox"]').change(function() {
                ...
                var inputBox = $(this).siblings('div').find('input[type="text"]');
