            ...
            <div class="card">
                ...
                <div id="print-area" class="card-body border">
                    <div class="row" style="position:relative;">
                        <h4 style="position: absolute;top: 78px;left: 44%;border-bottom: 1px solid #000;">Treatment Plan</h4>
                    </div>
                    <div class="row ">
                        <div class="col-12">
                    ...
                    <div class="row col-12 p-0 m-0">
                        ...
                        <div class="col-8 text-right">
                            <h6 class="size">@lang('MRN No'):
                                {{ $patientTreatmentPlan->patient->patientDetails->mrn_number }}
                            </h6>
                        </div>
