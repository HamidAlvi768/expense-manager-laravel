                                                ...
                                                <td class="border ">
                                                                ...
                                                                <div class="col-6">
                                                                    <div id="notesButtons">
                                                                        ...
                                                                        <button style="width:107px !important;margin-bottom:5px;" type="button" class="btn btn-sm btn-primary"
                                                                            data-toggle="modal"
                                                                            data-target="#declineModal_{{$tooth->tooth_number}}">Add Notes</button>
                                                    ...
                                                    ->count();
                                                                        ...
                                                                        @if ($patientNotesCount > 0)
                                                                            ...
                                                                            <!-- Show Modal -->
                                                            <div class="modal fade show_treatment_notes" id="showModal<?= $tooth->tooth_number ?>" tabindex="-1"
                                                                        ...
                                                                        <div class="modal-body" style="height: 400px;overflow-y:scroll;">
                                                                            ...
                                                                            <table class="table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <?php if($patientNote->tooth_number == $tooth->tooth_number) {
