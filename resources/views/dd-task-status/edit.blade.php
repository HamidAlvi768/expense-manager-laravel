            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Edit Task Status')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Edit Task Status'): {{ $ddTaskStatus->title }}</h3>
                </div>
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal bg-custom"
                        action="{{ route('dd-task-status.update', $ddTaskStatus) }}" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="name" name="title"
                                            value="{{ old('title', $ddTaskStatus->title) }}"
                                            class="form-control @error('title') is-invalid @enderror"
                                            placeholder="@lang('Title')" required
                                            data-parsley-required-message="Please enter status title.">
                                        @error('title')
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="email" name="description"
                                            value="{{ old('description', $ddTaskStatus->description) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control ambitious-form-loading @error('status') is-invalid @enderror"
                                            ...
                                            <option value="1" {{ old('status', $ddTaskStatus->status) == '1' ? 'selected' : '' }}>
                                                @lang('Active')
                                            </option>
                                            <option value="0" {{ old('status', $ddTaskStatus->status) == '0' ? 'selected' : '' }}>
                                                @lang('Inactive')
                                            </option>
                                        </select>
                                        @error('status')
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <a href="{{ route('dd-task-status.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
