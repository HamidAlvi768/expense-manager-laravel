...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                <form id="taskStatusForm" class="form-material form-horizontal bg-custom" action="{{ route('dd-task-status.store') }}" method="POST" enctype="multipart/form-data" data-parsley-validate>
                    @csrf
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-4 col-xl-4">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    data-parsley-required-message="Please enter status title." data-parsley-trigger="change focusout">
                                    @error('title')
...
<<<<<<< HEAD
                                    ...
                                    <a href="{{ route('dd-task-type.index') }}" class="btn btn-outline btn-warning btn-md">@lang('Cancel')</a>
=======
