...
<script>
    $(document).ready(function(){
        ...
        // Special initialization for income category table
        if ($('#income_category_table').length) {
            $('#income_category_table').DataTable({
                "paging": false,
                "lengthChange": false,
                "searching": false,
                "ordering": true,
                ...
                columnDefs: [
                    { responsivePriority: 1, targets: -1 } // Gives highest priority to last column (Actions)
                ]
            });
        }

        // Special initialization for keyword table
