                                ...
                                <table id="t1" class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" class="custom-th-width-20">Procedure (CPT)<b class="ambitious-crimson">*</b></th>
                                    ...
                                    <tbody id="invoice-body">
                                        @if (isset($patientTreatmentPlanProcedures))
                                            @foreach ($patientTreatmentPlanProcedures as $planProcedure)
                                                ...
                                                <td style="padding-bottom: 30px;">
                                                    ...
                                                    <td style="padding-bottom: 30px;">
                                                        <button title ="Add" type="button" class="btn btn-info m-add"><i class="fas fa-plus"></i></button>
                                                        <button title="Delete" type="button" class="btn btn-info m-remove"><i class="fas fa-trash"></i></button>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @endif
                                        @if (!(isset($patientTreatmentPlanProcedures)))
                                            ...
                                            <input type="hidden" name="patient_treatment_plan_procedure_id[]" value="">
                                                ...
                                                <td style="padding-bottom: 30px;">
                                                    <button title="Add" style="margin-top:5px;" type="button" class="btn btn-info m-add"><i class="fas fa-plus"></i></button>
                                                    <button title="Delete" style="margin-top:5px;" type="button" class="btn btn-info m-remove"><i class="fas fa-trash"></i></button>
                                                </td>
                                            </tr>
                                        @endif
                                    </tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" step="1" name="discount_percentage" value="{{ old('discount_percentage', '0') }}" class="form-control discount_percentage" placeholder="">
                                                </div>
                                            </td>
                                            <td>
