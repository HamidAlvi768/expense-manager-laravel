                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
<<<<<<< HEAD
                                    <input id="submit_campaign" type="submit" value="{{ __('Submit') }}" class="btn btn-outline btn-info btn-md"/>
                                    <a href="{{ route('email-templates.index') }}" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
