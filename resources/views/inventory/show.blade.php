        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">{{ $inventory->item->title ?? '-' }}</h3>
                </div>
                <div class="card-body">
                    ...
                    <div class="bg-custom">
                        <div class="row col-12 m-0 p-0">
                            ...
                            <div class="col-6 col-sm-4 col-md-2">
                                <div class="form-group">
                                    <label for="Quantity">@lang('Qty in stock') <b class="text-danger"></b></label>
    ...
    <div class="container">
        <div class="table-responsive">
            <table class="table table-striped table-bordered">
                ...
                <tbody>
                    @foreach ($additionInventorys as $additionInventory)
                        <tr>
                            <td>{{ $additionInventory->createdBy->name ?? ' ' }}</td>
                            <td>{{ $additionInventory->quantity }}</td>
                            <td>{{ $additionInventory->unitprice }}</td>
                            <td>{{ $additionInventory->created_at->format('Y-m-d H:i:s') }}</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>
