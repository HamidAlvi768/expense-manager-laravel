        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6 d-flex">
                    <h3 class="mr-2">
                        <a href="{{ route('dd-task-type.create') }}" class="btn btn-outline btn-info">
                            + @lang('Add Task Type')
                        </a>
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">@lang('Edit Task Type')</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-info">
                    <h3 class="card-title">@lang('Edit Task Type'): {{ $ddTaskType->title }}</h3>
                </div>
                <div class="card-body">
                    <form id="departmentForm" class="form-material form-horizontal bg-custom"
                        action="{{ route('dd-task-type.update', $ddTaskType) }}" method="POST"
                        ...
                        <div class="row col-12 m-0 p-0">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" id="name" name="title"
                                            value="{{ old('title', $ddTaskType->title) }}"
                                            class="form-control @error('title') is-invalid @enderror"
                                            placeholder="@lang('Title')" required data-parsley-required="true"
                                            data-parsley-required-message="Please enter type title."
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="email">@lang('Description') <b class="ambitious-crimson"></b></label>
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-file"></i></span>
                                        </div>
                                        <input type="text" id="email" name="description"
                                            value="{{ old('description', $ddTaskType->description) }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select
                                            ...
                                            data-parsley-trigger="change">
                                            <option value="1"
                                                {{ old('status', $ddTaskType->status) == '1' ? 'selected' : '' }}>
                                                @lang('Active')
                                            </option>
                                            <option value="0"
                                                {{ old('status', $ddTaskType->status) == '0' ? 'selected' : '' }}>
                                                @lang('Inactive')
                                            </option>
                                        </select>
                                        @error('status')
