...
@section('content')
    <div class="dashboard-filter-section">
        <div class="filter-header">
            <div class="row align-items-center justfiy-space-between">
                ...
                <div class="row">
                    <div class="col-md-4 custom-box">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text d-flex">@lang('Total Incomes:')<span class="info-box-number"
                                        id="total-incomes-count">{{ $dashboardCounts['incomes'] }}</span></span>
                                <span class="info-box-text d-flex">@lang('Total Amount:')<span class="info-box-number"
                                        id="total-income-amount">{{ formatAmount($dashboardCounts['income_total']) }}</span></span>
                    ...
                    <div class="col-md-4 custom-box">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text d-flex">@lang('Total Expenses: ')<span class="info-box-number"
                                        id="total-expenses-count">{{ $dashboardCounts['expenses'] }}</span></span>
                                <span class="info-box-text d-flex">@lang('Total Amount: ')<span class="info-box-number"
                                        id="total-expense-amount">{{ formatAmount($dashboardCounts['expense_total']) }}</span></span>
                    ...
                    <div class="col-md-4 custom-box">
                        <div class="info-box">
                            ...
                            <div class="info-box-content">
                                <span class="info-box-text d-flex">@lang('Total Transfers'):<span class="info-box-number"
                                        id="total-transfers-count">{{ $dashboardCounts['transfers'] }}</span></span>
                                <span class="info-box-text d-flex">@lang('Transfers Amount'):<span class="info-box-number"
                                        id="total-transfer-amount">{{ formatAmount($dashboardCounts['transfer_total']) }}</span></span>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-2">
            <div class="card" style="width: max-content;">
                <div class="card-header">
                    Expenses Breakdown
                    <select id="expenseDateFilter" class="form-control"
                        style="float: right; width: 40%; height: auto; font-size: 10px;">
                ...
                <div class="card-body" style="min-height: 200px;">
                    <div class="row">
                        <div class="col-md-6">
                            <canvas id="expenseDoughnut" width="200" height="200"></canvas>
                        </div>
                        <div class="col-md-5">
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header">
                    ...
                    <select id="budgetMonthFilter" class="form-control"
                        style="float: right; width: auto; height: 30px; font-size: 12px;">
