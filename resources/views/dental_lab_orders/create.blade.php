                    ...
                    <div class="row col-12 m-0 p-4 mt-4">
                            ...
                            <div class="col-6 m-0 p-0 h-100 border border-dark"
                                ...
                                <div class="row col-12 m-0 mt-2 p-0">
                                    <div class="p-0 px-1 col-12 text-center">
                                        <h5 id="labname" style="font-style: italic; font-weight: bold;"></h5>
                                    </div>
                                </div>
                        ...
                        text-align: center;">
                                ...
                                <div class="col-4 ml-3 my-auto">
                                    <div class="row justify-content-between">
                                        <p style="width:fit-content;margin: 0px; font-weight: bold;">Implant</p>
                                        <input style="width: fit-content;" type="checkbox" current-color="HotPink" name="pfm_implant"
                                            id="pfm_implant">
                                    </div>
                                    <div class="row justify-content-between">
                                        <p style="width:fit-content;margin: 0px; font-weight: bold;">Post & Core</p>
                                        <input style="width: fit-content;" type="checkbox" current-color="LightBlue" name="pfm_post_and_core"
                                    ...
                                    <div class="row justify-content-between">
                                        <p style="width:fit-content;margin: 0px; font-weight: bold;">Bridges</p>
                                        <input style="width: fit-content;" type="checkbox" current-color="LightSalmon" name="pfm_bridges"
                                            id="pfm_bridges">
                                    </div>
                                </div>
                            </div>
...
<<<<<<< HEAD
                                ...
                                <a href="#" class="btn btn-outline btn-warning btn-md">{{ __('Cancel') }}</a>
=======
