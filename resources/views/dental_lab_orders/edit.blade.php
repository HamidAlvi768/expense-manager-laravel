                                        ...
                                        <div class="col-6 m-0 p-0 h-100 border border-dark"
                                            ...
                                            <div class="row col-12 m-0 mt-2 p-0">
                                                <div class="p-0 px-1 col-12 text-center">
                                                    <h5 id="labname" style="font-style: italic; font-weight: bold;">
                                                    </h5>
                                                </div>
                                            </div>
                        ...
                        text-align: center;">
                                            ...
                                            <div class="ml-5 my-auto">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="DarkCyan" name="zirconia_non_pre_veneers"
                                                ...
                                                <div class="row justify-content-between">
                                                    <p
                                                        ...
                                                        Veneers</p>
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="DarkKhaki" name="zirconia_veneers" id=""
                                                ...
                                                <div class="row justify-content-between">
                                                    <p
                                                        ...
                                                        Crown</p>
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="Aqua" name="zirconia_crown" id=""
                                                ...
                                                <div class="row justify-content-between">
                                                    <p
                                                        ...
                                                        Bridges</p>
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="Aquamarine" name="zirconia_bridges" id=""
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="p-0 text-center"
                                                                    style="width: 33px;  background:{{ $dentalLabOrder->shade_d_bottom_8}}; min-width:0px;">8
                                                                    <input type="checkbox" selected-color=""
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="p-0 text-center"
                                                                    style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_8}}; min-width:0px;">8
                                                                    <input type="checkbox" selected-color=""
                        ...
                        text-align: center;">
                                            ...
                                            <div class="col-4 ml-5 my-auto">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="HotPink" name="pfm_implant" id=""
                                                ...
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="LightBlue" name="pfm_post_and_core" id=""
                                                ...
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox"
                                                        current-color="LightSalmon" name="pfm_bridges" id=""
...
@push('scripts')
    ...
    $('#lab_id').on('change', function() {
        ...
        // Display the selected value in the <h5> tag
        $('#labname').text(selectedOption);
    });


    var selectedOption1 = $('#lab_id').val();
    
    // Display the selected value in the <h4> tag
    $('#labname').text(selectedOption1);
