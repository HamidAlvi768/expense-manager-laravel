...
@section('content')
                        ...
                        text-align: center;">
                                            ...
                                            <div class="ml-5 my-auto">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" current-color="DarkCyan" type="checkbox" name=""
                               id=""{{ $dentalLabOrder->zirconia_non_pre_veneers == '1' ? 'checked' : '' }}  disabled>
                                                ...
                                                <div class="row justify-content-between">
                                                    <p
                                                        style="width:fit-content;margin: 0px; margin-right:5px; font-weight: bold;">
                                                        Veneers</p>
                                                    <input style="width: fit-content;" current-color="DarkKhaki" type="checkbox" name=""
                                                ...
                                                <div class="row justify-content-between">
                                                    <p
                                                        style="width:fit-content;margin: 0px; margin-right:5px; font-weight: bold;">
                                                        Crown</p>
                                                    <input style="width: fit-content;" current-color="Aqua" type="checkbox" name=""
                                                ...
                                                <div class="row justify-content-between">
                                                    <p
                                                        style="width:fit-content;margin: 0px; margin-right:5px; font-weight: bold;">
                                                        Bridges</p>
                                                    <input style="width: fit-content;" current-color="Aquamarine" type="checkbox" name=""
                                        ...
                                        <table class="table table-bordered border-dark">
                                            <tbody>
                                                <tr>
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_8}};">
                                                        8
 ...
 disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_7}};">7
 ...
 disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_6}};">6
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_5}};">5
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_4}};">4
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_3}};">3
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_2}};">2
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_top_1}};">1
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_1}};">1
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_2}};">2
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_3}};">3
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_4}};">4
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_5}};">5
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_6}};">6
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_d_bottom_7}};">7
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; min-width:0px;  background:{{ $dentalLabOrder->shade_d_bottom_8}};">8
                                                ...
                                                <tr>
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_8}};">
                                                        8
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_7}};">7
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_6}};">6
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_5}};">5
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_4}};">4
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_3}};">3
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_2}};">2
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_top_1}};">1
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_1}};">1
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_2}};">2
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_3}};">3
 ...
 disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_4}};">4
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_5}};">5
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_6}};">6
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_7}};">7
  ...
  disabled>
                                                    ...
                                                    <td class="p-0 text-center" style="width: 33px; background:{{ $dentalLabOrder->shade_m_bottom_8}}; min-width:0px;">8
                                            ...
                                            <div class="ml-5 my-auto">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" current-color="yellow" type="checkbox" name=""
                                                        id="" {{ $dentalLabOrder->e_max_non_pre_veneers == '1' ? 'checked' : '' }}  disabled>
                                                </div>
                                                <div class="row justify-content-between">
                                                    <p
                                                        style="width:fit-content;margin: 0px; margin-right:5px; font-weight: bold;">
                        ...
                        text-align: center;">
                                            ...
                                            <div class="col-4 ml-5 my-auto">
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox" current-color="HotPink" name=""
                                                ...
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox" current-color="LightBlue" name=""
                                                ...
                                                <div class="row justify-content-between">
                                                    ...
                                                    <input style="width: fit-content;" type="checkbox" current-color="LightSalmon" name=""
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    selectedColorCheckboxes.forEach(selectedColorCheckbox => {
        selectedColorCheckbox.addEventListener('click', function() {
            ...
            const parentTd = selectedColorCheckbox.closest('td'); // Get the parent <td> element
