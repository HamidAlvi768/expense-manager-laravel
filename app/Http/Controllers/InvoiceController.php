...
class InvoiceController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('invoices.create', compact('accountHeader', 'insurances', 'patients', 'doctors','procedureCategories','procedures'));
    }
        ...
        DB::transaction(function () use ($request, $invoice) {
            ...
            foreach ($request->patient_treatment_plan_procedure_id as $key => $value) {
                ...
                if(!empty($request->procedure_id[$key])) {
                    $modelProcedure = \App\Models\DdProcedure::find($request->procedure_id[$key]);
                }
