...
class PrescriptionController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $prescriptionData = $request->only(['user_id', 'note', 'prescription_date']);
        ...
        if ($request->has('medicine_name')) {
            foreach ($request->medicine_name as $key => $medicineName) {
                ...
                $medicineItem->instruction = $request->medicine_description[$key];
                $medicineItem->days = $request->days[$key];
                $medicineItem->weeks = $request->weeks[$key];
                $medicineItem->months = $request->months[$key];
                $medicineItem->save();
            }
        }
    ...
    public function update(Request $request, Prescription $prescription)
    {
        ...
        $prescriptionData = $request->only([
            'user_id', 'note', 'prescription_date'
        ]);
